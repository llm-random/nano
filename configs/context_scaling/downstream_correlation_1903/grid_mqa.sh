...
DIR="context_scaling/downstream_correlation_1903"
...
# k12
python run_exp.py --config-path configs --config-name $DIR/mqa_k12 \
...
# k16
python run_exp.py --config-path configs --config-name $DIR/mqa_k16 \
  common.sequence_length=1024 common.batch_size=128
...
# k20
python run_exp.py --config-path configs --config-name $DIR/mqa_k20 \
  common.sequence_length=1024 common.batch_size=128
