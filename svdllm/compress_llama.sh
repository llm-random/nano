...
python SVDLLM.py --model meta-llama/Llama-3.2-1B --step 1 --ratio -2.0 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path $PROJECT_HOME_PATH/svdllm



# python SVDLLM.py --step 4 --model_path $PROJECT_HOME_PATH/svdllm/jeffwan_llama_7b_hf_whitening_only_0.8.pt
...
python utils/LoRA.py --prune_model $PROJECT_HOME_PATH/svdllm/jeffwan_llama_7b_hf_whitening_only_0.8.pt --data_path yahma/alpaca-cleaned --output_dir $PROJECT_HOME_PATH/svdllm/first_half --lora_target_modules q_u_proj,k_u_proj,v_u_proj,o_u_proj,gate_u_proj,down_u_proj,up_u_proj --lora_r 8 --num_epochs 3 --learning_rate 1e-4 --batch_size 64

python SVDLLM.py --model_path $PROJECT_HOME_PATH/svdllm/jeffwan_llama_7b_hf_whitening_only_0.8.pt --lora $FINE_TUNE_PATH/first_half /first_half --step 4
