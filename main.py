...
def initialize_training_components(cfg, metric_logger=None):
    ...
    Returns:
        tuple: (model, optimizer, scheduler, metric_logger, training_state) or (None, None, None, None, None) on failure
    """
    ...
    return model, optimizer, scheduler, metric_logger, training_state
