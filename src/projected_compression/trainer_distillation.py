...
class PCDistillationTrainer(TrainerDistillation):
    ...
    def save_hf_checkpoint(self, save_path):
        ...
        In distillation mode, source_model is also the teacher — its embedding is
        still accessible at source_model.embedding.weight (norms are NOT set to None
        in this mode, but the embedding path is identical to the non-distillation case).
