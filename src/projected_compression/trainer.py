        ...
        for step, batch in zip(
            ...
            if self.only_compress_model_gradient_clipping:
                ...
                self.model.pass_gradient_to_projections(
                    self.block_optimizers, self.block_schedulers, self.gradient_clipping, shared_gradient_norms=False
                )
            else:
                grad_norm = self.model.pass_gradient_to_projections(
                    self.block_optimizers, self.block_schedulers, self.gradient_clipping, shared_gradient_norms=True
                )
